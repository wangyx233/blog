            ...
            <div class="container">
                <div class="level">
                    <div class="level-start">
                        ...
                        <p class="is-size-7">
                            <span dangerouslySetInnerHTML={{ __html: `&copy; ${siteYear} ${author || siteTitle}` }}></span><a href="https://beian.miit.gov.cn" target="_blank" style={{margin: '0 6px'}}>京ICP备19009952号-1</a>
